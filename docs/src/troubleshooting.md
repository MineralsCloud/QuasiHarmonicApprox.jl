...
[discuss with us](https://github.com/MineralsCloud/QuasiHarmonicApprox.jl/discussions).

_If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/QuasiHarmonicApprox.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/QuasiHarmonicApprox.jl/compare) with suggestions._
