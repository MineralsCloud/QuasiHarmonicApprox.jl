...
[`QuasiHarmonicApprox`](https://github.com/MineralsCloud/QuasiHarmonicApprox.jl).
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("QuasiHarmonicApprox")
   ```

3. Run

   ```julia-repl
   julia> using QuasiHarmonicApprox
   ```
...
version of `QuasiHarmonicApprox`, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/QuasiHarmonicApprox.jl"
```

in the second step above.

## Update `QuasiHarmonicApprox`
...
our [GitHub repository](https://github.com/MineralsCloud/QuasiHarmonicApprox.jl)
for new releases.
Once we release a new version, you can update `QuasiHarmonicApprox` by typing

```@repl
using Pkg
Pkg.update("QuasiHarmonicApprox")
Pkg.gc()
```

in the Julia REPL.

## Uninstall and reinstall `QuasiHarmonicApprox`
