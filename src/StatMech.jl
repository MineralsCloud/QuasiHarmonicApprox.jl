...
bose_einstein_distribution(temperature::Float64, frequency::Float64)::Float64 = 1 / (exp(HBAR * frequency / (BOLTZMANN * temperature)) - 1)

function subsystem_partition_function(temperature::Float64, frequency::Float64)::Float64
...
function subsystem_free_energy(temperature::Float64, frequency::Float64)::Float64
...
function subsystem_internal_energy(temperature::Float64, frequency::Float64)::Float64
    validate_frequency(frequency)
...
function subsystem_entropy(temperature::Float64, frequency::Float64)::Float64
    validate_frequency(frequency)
...
function subsystem_volumetric_specific_heat(temperature::Float64, frequency::Float64)::Float64 
    validate_frequency(frequency)
